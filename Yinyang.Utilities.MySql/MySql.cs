...
namespace Yinyang.Utilities.MySql
{
    public class MySql : IDisposable
    {
        ...
        /// <summary>
        /// Gets or sets the string used to open a MySql database.
        /// </summary>
...
        public string CommandText
        ...
        public MySql()
        {
            ...
            _sqlCommand = new MySqlCommand { Connection = _sqlConnection };
        }
...
        public void AddParameter(string key, object obj)
        {
            _sqlCommand.Parameters.Add(obj == null
                ? new MySqlParameter(key, DBNull.Value)
                : new MySqlParameter(key, obj));
        }
